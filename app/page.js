...
const STEPS = [
  ...
  },
  {
    ...
    accent: 'text-hive-copper',
    ring: 'border-hive-copper/45',
  },
  {
    n: '04',
    title: 'Permit',
...
const MODULES = [
  ...
  { name: 'Shield', body: 'License, compliance, and assignment checks before work starts.', accent: 'text-hive-copper' },
  { name: 'Standard', body: 'The installation standard and quality record for every job.', accent: 'text-[#34E07A]' },
]

function IconConnected() {
  return (
    <svg viewBox="0 0 64 64" className="h-16 w-16 mx-auto" fill="none">
...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen hive-field text-white overflow-hidden">
      <nav className="w-full bg-[#07002E]/80 backdrop-blur-md border-b border-hive-cyan/15 sticky top-0 z-50 px-4 py-3">
        <div className="max-w-6xl mx-auto flex justify-between items-center gap-3">
          <a href="/" className="flex items-center gap-3 min-w-0">
            <img src="/images/logo-icon.svg" alt="HiveGrid Energy" className="h-14 w-14 sm:h-16 sm:w-16 shrink-0 drop-shadow-[0_0_18px_rgba(0,255,255,0.35)]" />
          ...
          <div className="hidden md:flex items-center gap-7 text-sm font-medium text-white/80">
            ...
            <a href="#how-it-works" className="hover:text-hive-copper transition-colors">How It Works</a>
            <a href="#platform" className="hover:text-hive-cyan transition-colors">Platform</a>
            <a href="#contact" className="hover:text-hive-copper transition-colors">Contact</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-3">
            <div className="flex flex-col gap-3 text-sm font-medium hive-card border border-hive-cyan/25 rounded-2xl p-4">
              ...
              <a href="#how-it-works" onClick={closeMenu} className="py-1 text-hive-copper">How It Works</a>
              <a href="#platform" onClick={closeMenu} className="py-1 text-hive-cyan">Platform</a>
              <a href="#contact" onClick={closeMenu} className="py-1 text-hive-copper">Contact</a>
      ...
      <section className="relative px-5 pt-20 pb-16 md:pt-28 md:pb-20">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-hive-copper/15 border border-hive-copper/40 text-hive-copper px-4 py-1.5 rounded-full text-xs mb-8 font-semibold tracking-[0.16em] uppercase">
            Texas residential battery installation
          </div>
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight mb-6 leading-[0.95] text-hive-cyan drop-shadow-[0_0_28px_rgba(0,255,255,0.25)]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="#how-it-works" className="bg-hive-cyan text-hive-indigo hover:brightness-110 font-semibold px-10 py-4 rounded-2xl text-base transition-all shadow-[0_0_30px_rgba(0,255,255,0.25)]">
              Start to finish
            </a>
            <a href="#contact" className="border border-hive-copper/70 bg-hive-copper/15 hover:bg-hive-copper/25 font-semibold px-10 py-4 rounded-2xl text-base transition-all text-hive-copper">
              For partners
            </a>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {ICONS.map(({ label, Icon }) => (
            <div key={label} className="hive-card border border-white/10 rounded-3xl px-3 py-6 text-center">
              <Icon />
              <div className="mt-4 text-[11px] sm:text-xs font-semibold tracking-[0.14em] uppercase text-white/85 leading-snug">
                {label}
              </div>
            </div>
          ))}
      ...
      <section id="about" className="px-5 pb-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold mb-3 text-hive-cyan">What HiveGrid actually is</h2>
          <div className="h-1 w-16 bg-hive-copper rounded-full mb-8" />
          <div className="hive-card border border-hive-cyan/20 rounded-3xl p-6 md:p-10 space-y-5 text-base md:text-lg leading-relaxed text-white/85">
            <p>
            ...
            <p className="font-medium text-hive-copper">
      ...
      <section id="how-it-works" className="px-5 pb-20">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-4xl mb-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 text-hive-cyan">Start to finish</h2>
            <div className="h-1 w-16 bg-hive-copper rounded-full mb-5" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {STEPS.map((step) => (
              <div key={step.n} className={`hive-card border ${step.ring} rounded-3xl p-6`}>
                <div className={`text-sm font-semibold tracking-[0.22em] ${step.accent} mb-3`}>{step.n}</div>
                <h3 className={`text-2xl font-bold mb-3 ${step.accent}`}>{step.title}</h3>
      ...
      <section id="platform" className="px-5 pb-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold mb-3 text-hive-cyan">HiveGrid OS</h2>
          <div className="h-1 w-16 bg-hive-copper rounded-full mb-5" />
      ...
      <section id="contact" className="px-5 pb-16">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-3 text-hive-cyan">Work with HiveGrid</h2>
          <div className="h-1 w-16 bg-hive-copper rounded-full mx-auto mb-5" />
          <p className="text-hive-copper mb-2">For strategic partners.</p>
              ...
              <>
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    placeholder="Email"
                    required
                    className="flex-1 hive-card border border-hive-cyan/30 rounded-2xl px-5 py-3.5 text-white placeholder:text-white/40 focus:outline-none focus:border-hive-copper"
                  />
                  <button
                    type="submit"
                    disabled={sending}
                    className="bg-hive-copper hover:brightness-110 text-white font-semibold px-8 py-3.5 rounded-2xl disabled:opacity-60"
                  >
      ...
      <footer className="border-t border-hive-cyan/15 py-10 text-center text-sm text-white/55 px-5">
      ...
      {showBackToTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-hive-copper text-white shadow-lg hover:brightness-110"
