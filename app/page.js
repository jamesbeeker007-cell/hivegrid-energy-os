...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-hive-green text-circuit-white">
      {/* Navigation */}
      <nav className="w-full bg-hive-green/90 backdrop-blur-md border-b border-silver-node/30 sticky top-0 z-50 px-6 py-5 flex justify-between items-center">
      ...
      {/* New Elegant Hero */}
      <section className="min-h-screen bg-hive-green text-circuit-white flex items-center justify-center relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-bold font-space-grotesk tracking-tight mb-6">
            Not one giant power plant.<br />
            <span className="text-electric-amber">Thousands of smart ones.</span>
          </h1>
      ...
      <section id="how-it-works" className="max-w-5xl mx-auto mt-32 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-hive-green/50 border border-silver-node/30 rounded-3xl p-8">
      ...
      <section id="platform" className="max-w-5xl mx-auto mt-32 px-6 bg-hive-green/50 rounded-3xl py-16 text-center">
          ...
          {!submitted ? (
            <>
              <input
                ...
                className="flex-1 bg-hive-green/50 border border-silver-node rounded-2xl px-6 py-4 focus:outline-none focus:border-electric-amber"
              />
              <button
                type="submit"
