  ...
  return (
    <main className="min-h-screen bg-[#0F172A] text-circuit-white">
      ...
      <section className="min-h-screen bg-[#0F172A] text-circuit-white flex items-center justify-center relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl md:text-3xl text-silver-node max-w-3xl mx-auto mb-10">
            ...
            creating a resilient, distributed energy network more powerful than any single centralized facility.
          </p>
      ...
      <section id="platform" className="max-w-5xl mx-auto mt-32 px-6 bg-[#0F172A] rounded-3xl py-16 text-center">
        <h3 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-electric-amber to-amber-400 bg-clip-text text-transparent">
          HiveGrid Energy OS
        </h3>
